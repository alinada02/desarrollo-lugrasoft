document.addEventListener("DOMContentLoaded", function() {
    ...
    option1.value = 'unidad1'; // Asigna el valor deseado para la opción
    option1.textContent = 'Unidad 1'; // Texto visible de la opción
    selectUnidad.appendChild(option1);

    var option2 = document.createElement('option');
    option2.value = 'unidad2'; // Asigna el valor deseado para la opción
    option2.textContent = 'Unidad 2'; // Texto visible de la opción
