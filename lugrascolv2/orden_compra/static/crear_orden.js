document.addEventListener("DOMContentLoaded", function() {
    ...
    productoSelector.addEventListener("change", function() {
        ...
        nuevaFila.insertCell().textContent = fechaCreacionInput; //6
    ...
    // Asignar eventos onblur para calcular y actualizar el total
        ...
        divTotalFactura.textContent = "Total de la factura: $" + totalFactura.toFixed(2); // Redondear el total a 2 decimales
        divTotalFactura.style.color = 'red'
